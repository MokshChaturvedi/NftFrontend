                ...
                <div className="row">
                    <div className="col-lg-7">
                        <div className="sign-from contact-form">
                            <h2 className="textwhitecolor contact-head">Contact Us</h2>
                            <form>
                                <div className="row">
                                    ...
                                    <div className="col-md-4">
                                        <div className="input-box">
                                            <input type="email" name="email" placeholder="E-mail" className="form-input" />
                                        </div>
                                    </div>
                                </div>
                                <div className="input-box">
                                    <input type="text" name="sub" placeholder="Subject of message" className="form-input" />
                                </div>
                                <div className="input-box">
                                    <textarea className="form-input" placeholder="Enter the message" defaultValue={""} />
                                </div>
                                <div className="contact-submit">
                                    <button className="btn btnlightblue">Send message</button>
                                </div>
                            </form>
                        </div>
                    </div>
                    <div className="col-lg-5">
                        <div className="about-crypton">
                            <h2 className="textwhitecolor contact-head">About <span className="textbluecolor">Crypto</span>N</h2>
                            <p>Lorem Ipsum is simply <span className="textbluecolor">dummy text of the printing</span> and typesetting industry. Lorem Ipsum has been the industry's standard dummy  has been the industry's standard dummy  has been the industry's standard dummy</p>
                            ...
                            <div className="joincommunity mt-3">
                                <ul>
                                    <li><a href="#"><img className="img-fluid" src="img/discordbutton.svg" alt="img" /></a></li>
                                    <li><a href="#"><img className="img-fluid" src="img/twitter.svg" alt="img" /></a></li>
                                    <li><a href="#"><img className="img-fluid" src="img/insta.svg" alt="img" /></a></li>
                                    <li><a href="#"><img className="img-fluid" src="img/reditbutton.svg" alt="img" /></a></li>
                                    <li><a href="#"><img className="img-fluid" src="img/youtube.svg" alt="img" /></a></li>
                                    <li><a href="#"><img className="img-fluid" src="img/emailbutton.svg" alt="img" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
